from  funcsParalComplexR11 import *
import pandas as pd
...
print("parallel WKB time for adj pairs: ",tWKBAdjEnd-tWKBUpperStart)
...
upperDf.to_csv("level"+str(levelStart)+"upperGComplexR11.csv",index=False)